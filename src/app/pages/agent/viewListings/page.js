...
export default function ListingsPage() {
    ...
    // Automatically set agentEmail from AuthContext user data
    const agentEmail = user?.email || ''; // Fallback to an empty string if user is not set
    ...
    const buildSearchFilters = () => {
        ...
        if (agentEmail) filters.agent_email = agentEmail; // Use the agent email from AuthContext
